...
import type { DomainRepository } from "./domain.port";
...
export class DomainApiAdapter implements DomainRepository {
...
export const domainApiAdapter = new DomainApiAdapter();
