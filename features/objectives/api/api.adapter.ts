...
import type { ObjectiveRepository } from "./objective.port";
...
export class ObjectiveApiAdapter implements ObjectiveRepository {
...
export const objectiveApiAdapter = new ObjectiveApiAdapter();
